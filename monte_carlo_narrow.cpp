...
int main() {
    ...
    minX = max({c[0].x - c[0].r, c[1].x - c[1].r, c[2].x - c[2].r});
    maxX = min({c[0].x + c[0].r, c[1].x + c[1].r, c[2].x + c[2].r});
    minY = max({c[0].y - c[0].r, c[1].y - c[1].r, c[2].y - c[2].r});
    maxY = min({c[0].y + c[0].r, c[1].y + c[1].r, c[2].y + c[2].r});
